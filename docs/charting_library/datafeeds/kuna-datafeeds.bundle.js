...
var KunaDatafeeds = /** @class */ (function (_super) {
    __extends(KunaDatafeeds, _super);
    function KunaDatafeeds(datafeedURL, updateFrequency) {
        if (updateFrequency === void 0) { updateFrequency = 10 * 1000; }
        var _this = this;
    ...
    return KunaDatafeeds;
}(UDFCompatibleDatafeedBase));

exports.KunaDatafeeds = KunaDatafeeds;
